...
**Data:** 2026-05-28
**Gatilho:** primeira apresentação à diretoria. Feedback: "parece software de 5 anos atrás, UI/UX muito simples". Diretoria pediu pra Erick procurar SaaS de referência *como se fosse contratar um por unidade*. Amplimed (médico) foi mencionado mas explicitamente NÃO é referência.
...
- **ClassApp BR** ([classapp.com.br](https://www.classapp.com.br)) — 600+ escolas. Substitui WhatsApp pessoal. *"Protege o número de telefone do staff"* — exatamente o problema da Danielle.
